...
if(send_mail($mailto, $subject, $text, $dest_path, $fileName.'.'.$fileExtension)) { echo 'Письмо с вложением отправлено'; unlink($dest_path); } else { echo 'Письмо с вложением НЕ отправлено'; }
} else {
if(mail($mailto, $subject, $text)) { echo 'Письмо без вложения отправлено'; } else { echo 'Письмо без вложения НЕ отправлено'; }
} 
?>